...
# On the other hand, a global variable is a variable that is defined outside of a function and is accessible from outside and within any function in your code(as long as iska khud ka koi same waisa hi variable na ho).
...
def my_function():
  ...
  y = 5 # local variable
          ...
          #isme pehle function execute kiya hai then x print kiya hai tb x ki value change hui .........agr pehle print kr dete then function chalate tb x ki value change nhi hoti
my_function()
print(x) # prints 5
print(y) # this will cause an error because y is a local variable and is not accessible outside of the function
